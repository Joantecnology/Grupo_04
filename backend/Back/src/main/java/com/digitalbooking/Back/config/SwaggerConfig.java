...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .tags(new Tag("Features", "Product Attribute Controller"))
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo("Booking_04",
                "Aplicación desarrollada para aplicar los conocimientos adquiridos a lo largo del primer track de la carrera de CTD. Este documento contiene toda la información para utilizar la API de Airc2c.\n" +
                        ...
                        "   - Ontiveros, Emilio\n" +
                        "   - Moreno, Jorge\n" +
                        "   - Albuquerque, Verónica\n" +
                        "   - Boschetti, Fabio\n" +
                        "   - Melo, Alexander \n" +
                        "   - Aguirre, Juan David",
                "V.0.0.1",
                "Terms of service",
                new Contact("Booking_04", "http://0521ptc2n2-grupo9-airc2cfronts3.s3-website.us-east-2.amazonaws.com/","airc2c@gmail.com"),
                "Licencia",
                "licencia.com",
